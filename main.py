...
def main():
    ...
    title_html = f"<h1 align=\"center\">BatGPT 学术优化 {get_current_version()}</h1>{theme_declaration}"
    ...
    with gr.Blocks(title="BatGPT 学术优化", theme=set_theme, analytics_enabled=False, css=advanced_css) as app_block:
        gr.HTML(title_html)
